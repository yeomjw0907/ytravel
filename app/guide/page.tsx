...
const GUIDE_STEPS = [
  ...
  "표시된 후보가 있으면 외부 사이트에서 객실 조건과 총액을 다시 확인합니다.",
  "BRG를 검토한다면 호텔 브랜드 정책을 마지막으로 확인합니다.",
];
    ...
    <Container size="md" className="py-wt-12 md:py-wt-16">
      <div className="rounded-wt-xl border border-wt-border bg-wt-panel p-wt-8 shadow-wt-card md:p-wt-10">
        ...
        <p className="mt-wt-4 text-wt-body-md leading-relaxed text-wt-text-secondary">
          Ytravel은 예약가를 기준으로 더 저렴한 후보를 빠르게 탐색하도록 돕는
          정보 서비스입니다. 예약 대행이나 가격 보장 서비스가 아니며, 검색 결과는
          지원 사이트 기준의 참고 정보입니다.
        </p>
        ...
        <section className="mt-wt-8">
          ...
          <p className="mt-wt-3 text-wt-body-sm leading-relaxed text-wt-text-secondary">
            현재는 제한된 공급처 기준으로 자동 비교를 제공합니다. 자동 비교가
            어려운 경우에는 수동 확인용 외부 링크를 함께 보여드립니다. 공급처 구조
            변경, 약관, 차단 정책에 따라 일부 결과는 일시적으로 제공되지 않을 수
            있습니다.
          </p>
        </section>
        ...
        <section className="mt-wt-8">
          ...
          <p className="mt-wt-3 text-wt-body-sm leading-relaxed text-wt-text-secondary">
            Ytravel은 BRG 적용 여부를 확정하지 않습니다. 객실, 취소 정책, 조식,
            세금, 결제 조건이 비슷한지를 먼저 보여주고, 실제 BRG 가능성 판단은
            호텔 브랜드 정책에 따라 사용자가 마지막으로 확인해야 합니다.
          </p>
        </section>
