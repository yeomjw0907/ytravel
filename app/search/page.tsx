  ...
  return (
    <div className="min-h-screen bg-wt-bg">
      ...
      <Container size="xl" className="py-wt-8 md:py-wt-10">
        ...
        {/* 5. Fallback 링크 */}
        <section className="mt-wt-10 rounded-wt-xl border border-wt-border bg-wt-panel p-wt-6 shadow-wt-card">
          <h2 className="font-display text-wt-h3 text-wt-text-primary">
            직접 확인할 수 있는 사이트
          </h2>
          ...
          <div className="mt-wt-4 flex flex-wrap gap-wt-3">
            {result.fallbackLinks.map((link) => (
              <a
                ...
                className="inline-flex h-11 items-center justify-center rounded-wt-md border-2 border-wt-brand-700 px-wt-4 text-wt-body-sm font-medium text-wt-brand-700 hover:bg-wt-info-bg focus-wt"
              >
                {link.name}
              </a>
            ))}
