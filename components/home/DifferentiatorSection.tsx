...
const ITEMS = [
  ...
  { label: "취소 조건", variant: "info" as const },
...
export function DifferentiatorSection() {
  return (
    <section className="bg-wt-surface pb-wt-14 pt-wt-16 md:pb-wt-20 md:pt-wt-24">
      <Container size="lg">
        ...
        <p className="mt-wt-3 max-w-2xl font-body text-wt-body-md leading-relaxed text-wt-text-secondary">
          예약가를 다시 점검할 때는 숫자보다 조건 차이가 더 중요합니다. Ytravel은 비교에
          필요한 핵심 조건을 함께 보여줘서 실제로 다시 확인해볼 만한 후보만 빠르게
          가려냅니다.
        </p>
