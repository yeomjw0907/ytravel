  ...
  return (
    <section className="bg-wt-bg py-wt-16 md:py-wt-20">
      <Container size="lg">
        ...
        <div className="mt-wt-10 grid gap-wt-6 md:grid-cols-3">
          {STEPS.map(({ step, title, description }) => (
            <Card key={step} padding="lg" hover className="flex flex-col">
              <span className="text-wt-caption font-semibold tracking-wide text-wt-brand-500">0{step}</span>
