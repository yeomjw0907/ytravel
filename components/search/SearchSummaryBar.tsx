...
export function SearchSummaryBar({ query, hotelName }: SearchSummaryBarProps) {
  ...
  return (
    <div className="flex flex-col gap-wt-3 border-b border-wt-border bg-wt-panel px-4 py-wt-5 shadow-[0_1px_0_0_var(--wt-color-border)] sm:px-5 md:flex-row md:items-center md:justify-between md:px-6 md:py-wt-5 lg:px-8">
